          ...
          {procedures.map(({key, icon: Icon}, idx) => (
            ...
            >
              <div className="aspect-[4/3] bg-[var(--gray-100)] flex items-center justify-center relative overflow-hidden">
                <Icon className="w-12 h-12 text-[var(--gold-400)] transition-transform duration-500 group-hover:scale-110" />
              ...
              <div className="p-6">
                <h3 className="text-lg font-semibold text-[var(--gray-900)] mb-2 group-hover:text-[var(--gold-700)] transition-colors duration-300">
                  {t(`${key}.name`)}
                </h3>
                <p className="text-sm text-[var(--gray-500)] leading-relaxed mb-4">
                  {t(`${key}.shortDescription`)}
                </p>
                <span className="inline-flex items-center gap-1 text-sm font-medium text-[var(--gold-600)] group-hover:text-[var(--gold-700)] transition-colors">
