      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="mx-auto max-w-7xl px-6 lg:px-12">
          <div className="max-w-3xl mx-auto text-center animate-fade-in-up">
            <div className="w-12 h-12 rounded-full bg-[var(--green-50)] flex items-center justify-center mx-auto mb-6">
              <Heart className="w-6 h-6 text-[var(--green-600)]" />
            </div>
      ...
      <section className="py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-12">
          <div className="flex items-center gap-3 mb-8 animate-fade-in-up">
            <Target className="w-6 h-6 text-[var(--green-600)]" />
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-12">
          <div className="bg-[var(--gray-900)] rounded-sm p-12 lg:p-16 text-center relative overflow-hidden animate-scale-in">
            ...
            <div className="relative">
              ...
              <Link
                href="/contact"
                className="inline-flex items-center gap-2 px-8 py-4 text-base font-medium bg-[var(--green-500)] text-white rounded-full hover:bg-[var(--green-400)] transition-all duration-300 shadow-lg hover:scale-[1.02]"
              >
